...
Голосовой помощник для определения кода ТНВЭД по аудио-описанию товара. Проект позволяет загрузить аудиофайл с описанием товара или проговорить вопрос с запрсом кода товара через микрофон и получить код ТНВЭД в формате JSON. Примеры аудиофайлов приложены (q_0001_0.wav)
